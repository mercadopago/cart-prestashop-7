...
window.onload = function() {    
    ...
    var checkbox_online_prepend = "<div class='mp-all_checkbox'>\
            ...
            <label for='checkmeon'><b class='mp-pointer mp-pl-5'>Selecciona pagos online</b></label>\
    </div>";
    ...
    var checkbox_offline_prepend = "<div class='mp-all_checkbox'>\
            ...
            <label for='checkmeoff'><b class='mp-pointer mp-pl-5'>Selecciona pagos presenciales</b></label>\
    </div>";
    ...
    collapse_body_prepend.innerHTML = "<div class='row mp-pb-25'>\
        <div class='col-md-12'>\
            <h4 class='mp-title-checkout-body'>Personaliza estas opciones y activa otras herramientas de nuestro módulo listas para usar.</h4>\
        </div>\
    </div>";
