...
<div class="panel">
    ...
    {if $log->isReadable}
        <div class="mercadopago-content">
            <div class="row">
                <div class="col-md-12">
                    <h4 class="mp-title-checkout-body">{l s='Here you can get Mercado Pago\'s log.' mod='mercadopago'}</h4>
                </div>
            </div>
            ...
            <div class="row mp-pt-25">
                <div class="col-xs-12">
                    <a href="{$log->url|escape:'html':'UTF-8'}" target="_blank"
                        class="btn btn-default mp-btn-credenciais">{l s='See log' mod='mercadopago'}</a>
                    <a href="{$log->url|escape:'html':'UTF-8'}" target="_blank" class="btn btn-default mp-btn-credenciais"
...
<div class="row">
    <div class="col-md-8">
        ...
        {if $country_link == 'mlb'}
            <a href="https://www.mercadopago.com.br/developers/pt/support"
                target="_blank">{l s='Get in touch with our support.' mod='mercadopago'}</a>
        {else}
            <a href="https://www.mercadopago.com.br/developers/es/support"
                target="_blank">{l s='Get in touch with our support.' mod='mercadopago'}</a>
        {/if}
    </div>
