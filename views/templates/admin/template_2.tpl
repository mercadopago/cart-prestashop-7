	...
	<div class="mercadopago-content">
            ...
            <div class="row mg-0">
                <div class="col-md-7 banner-gradient">
                    <div class="label-banner">
                        <h2 class="title-banner">{l s='Take off your online sales.' mod='mercadopago'}</h2>
                        <p class="text-banner">{l s='Offer your customers the best' mod='mercadopago'} <br> {l s='payment experience.' mod='mercadopago'}</p>
        ...
        <div class="mercadopago-installments">
            ...
            <div class="row text-center">
                <div class="col-md-12">
                    <p class="info-installments">{l s='We will charge you a fee for each payment you receive.' mod='mercadopago'}</p>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="panel-text-icon">
                        ...
                        <span class="text-beneficios">{l s='Charge as you want and sell without limits.' mod='mercadopago'}</span>
                    </div>
        ...
        <div class="mercadopago-recibopagos" style="background-image: url({$module_dir|escape:'html':'UTF-8'}views/img/bg-recibepagos.png)">            
            <div class="row">           
                <h2 class="title-recibopagos">{l s='How do I receive the payments?' mod='mercadopago'}</h2>
        ...
        <div class="mercadopago-footer" style="background-image: url({$module_dir|escape:'html':'UTF-8'}views/img/bg-footer.png)">
            <div class="row">                
                <div class="col-md-12">
                    ...
                    <a href="" class="btn btn-default btn-footer">{l s='Configure Mercado Pago in your store' mod='mercadopago'}</a>
                </div>
            </div>
        </div>
        ...
        <div class="mercadopago-partner">
            <div class="row">                
                ...
                <div class="col-md-6 right-partner">
                    {l s='View our' mod='mercadopago'} <a href="{$seller_protect_link|escape:'html':'UTF-8'}" target="_blank" class="fl-right">{l s='Seller Protection Program.' mod='mercadopago'}</a>
                </div>
            </div>
        </div>
