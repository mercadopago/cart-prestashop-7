    ...
    <div class="row frame-checkout-six">
        ...
        <div id="mercadopago-form" class="col-xs-12 col-md-12 col-12">
            <div id="mp-subtitle-div-title" class="col-md-12 col-12 frame-title">
                <p class="subtitle-checkout-six">{l s='Enter your card details' mod='mercadopago'}</p>
            </div>
            ...
            <div class="row">
                <div class="col-md-12 col-12 pb-10 mp-m-col">
                    ...
                    <input id="id-card-number" data-checkout="cardNumber" type="text"
                           ...
                           autocomplete="off"/>
                    <small id="mp-error-205" class="mp-erro-form" 
                           data-main="#id-card-number">{l s='Invalid card number' mod='mercadopago'}</small>
                    <small id="mp-error-E301"
                           class="mp-erro-form mp-error-E301" 
                           data-main="#id-card-number">{l s='Invalid card number' mod='mercadopago'}</small>
                </div>
            </div>
            ...
            <div id="mp-doc-div-title" class="col-md-12 col-12 frame-title">
                <p class="subtitle-checkout-six">{l s='Enter your document number' mod='mercadopago'}</p>
            </div>
