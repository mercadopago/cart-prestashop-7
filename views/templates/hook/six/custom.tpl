...
<form action="{$redirect}" method="post" class="custom-checkout-six" id="mp_custom_checkout">
    <div class="row frame-checkout-six">
        ...
        <div id="mercadopago-form" class="col-xs-12 col-md-12 col-12">
            <div id="mp-subtitle-div-title" class="col-md-12 col-12 frame-title">
                <p class="subtitle-checkout-six pt-10">{l s='Ingresa los datos de tu tarjeta' mod='mercadopago'}</p>
            </div>
            ...
            <div class="col-md-12 col-12 frame-title">
                <p class="subtitle-checkout-six pt-10">{l s='Cuántas cuotas querés pagar' mod='mercadopago'}</p>
            </div>
            ...
            <div class="row">
                ...
                <div id="container-installments" class="col-md-12 col-8 col-md-4 mp-m-col pl-15">
                    <label for="id-installments" class="pb-5 pt-10">{l s='Seleccione el número de cotas'
                        mod='mercadopago'}</label>
            ...
            <div class="row">
                <div class="col-md-12 col-xs-12 col-12 mp-m-col pt-20">
