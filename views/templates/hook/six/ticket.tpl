        ...
        <div id="mercadopago-form" class="col-xs-12 col-md-12 col-12">
                ...
                <div class="col-md-12 col-12 pb-20 px-0">
                    <div class="form-check mp-form-check">
                        <div class="col-md-4 col-4 col-xs-6">
                            ...
                            <label class="form-check-label pointer" for="mp_cpf">{l s='Individual' mod='mercadopago'}</label>
                        </div>
                    </div>
                    <div class="form-check mp-form-check">
                        <div class="col-md-4 col-4 col-xs-6 m-pr-0">
                            ...
                            <label class="form-check-label pointer" for="mp_cnpj">{l s='Legal Entity' mod='mercadopago'}</label>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-4 col-4 col-xs-6 pt-20" id="mp_box_firstname">
                    <label for="" id="mp_firstname_label" class="pb-5">{l s='First and Last Name' mod='mercadopago'} <em class="mp-required">*</em></label>
                    <label for="" id="mp_socialname_label" class="pb-5">{l s='Company number' mod='mercadopago'} <em class="mp-required">*</em></label>
                ...
                <div class="col-md-4 col-4 col-xs-6 pt-20 m-pr-0" id="mp_box_lastname">
                    <label for="" class="pb-5">{l s='Last Name' mod='mercadopago'} <em class="mp-required">*</em></label>
            ...
            <div class="row">
                <div class="col-md-8 col-8 col-xs-8 pt-10">
                    <label for="" class="pb-5">{l s='Address' mod='mercadopago'} <em class="mp-required">*</em></label>
                ...
                <div class="col-md-4 col-4 col-xs-4 pt-10">
                    <label for="" class="pb-5">{l s='Number' mod='mercadopago'} <em class="mp-required">*</em></label>
            ...
            <div class="row">
                <div class="col-md-4 col-4 col-xs-6 pt-10">
                    <label for="" class="pb-5">{l s='City' mod='mercadopago'} <em class="mp-required">*</em></label>
                ...
                <div class="col-md-4 col-4 col-xs-6 pt-10 m-pr-0">
                    <label for="" class="pb-5">{l s='State' mod='mercadopago'} <em class="mp-required">*</em></label>
                ...
                <div class="col-md-4 col-4 col-xs-12 pt-10 mp-m-col">
                    <label for="" class="pb-5">{l s='Postal Code' mod='mercadopago'} <em class="mp-required">*</em></label>
            ...
            <div class="row">
                <div class="col-md-12 col-xs-12 col-12 pt-20 mp-m-col">
                    <p class="all-required">{l s='Complete all fields, they are mandatory!' mod='mercadopago'}</p>
                </div>
            </div>
            {/if}

            <p class="subtitle-checkout-six">{l s='Please, select the issuer of face payments with which you want to make the purchase:' mod='mercadopago'}</p>
