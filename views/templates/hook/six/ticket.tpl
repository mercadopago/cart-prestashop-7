        ...
        <div id="mercadopago-form" class="col-xs-12 col-md-12 col-12">
                ...
                <div class="col-md-12 col-12 mp-pb-20 mp-px-0">
                    <div class="form-check mp-form-check">
                        <div class="col-md-4 col-4 col-xs-6">
                            ...
                            <label class="form-check-label mp-pointer" for="mp_cpf">{l s='Persona Física' mod='mercadopago'}</label>
                        </div>
                    </div>
                    <div class="form-check mp-form-check">
                        <div class="col-md-4 col-4 col-xs-6 m-mp-pr-0">
                            ...
                            <label class="form-check-label mp-pointer" for="mp_cnpj">{l s='Persona Jurídica' mod='mercadopago'}</label>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-4 col-4 col-xs-6 mp-pt-20" id="mp_box_firstname">
                    <label for="" id="mp_firstname_label" class="mp-pb-5">{l s='Nombre' mod='mercadopago'} <em class="mp-required">*</em></label>
                    <label for="" id="mp_socialname_label" class="mp-pb-5">{l s='Razón social' mod='mercadopago'} <em class="mp-required">*</em></label>
                ...
                <div class="col-md-4 col-4 col-xs-6 mp-pt-20 m-mp-pr-0" id="mp_box_lastname">
                    <label for="" class="mp-pb-5">{l s='Apellido' mod='mercadopago'} <em class="mp-required">*</em></label>
                ...
                <div class="col-md-4 col-4 col-xs-12 mp-pt-20 mp-m-col">
                    <label for="docNumberError" id="mp_cpf_label" class="mp-pb-5">{l s='CPF' mod='mercadopago'} <em class="mp-required">*</em></label>
                    <label for="docNumberError" id="mp_cnpj_label" class="mp-pb-5">{l s='CNPJ' mod='mercadopago'} <em class="mp-required">*</em></label>
            ...
            <div class="row">
                <div class="col-md-8 col-8 col-xs-8 mp-pt-10">
                    <label for="" class="mp-pb-5">{l s='Dirección' mod='mercadopago'} <em class="mp-required">*</em></label>
                ...
                <div class="col-md-4 col-4 col-xs-4 mp-pt-10">
                    <label for="" class="mp-pb-5">{l s='Número' mod='mercadopago'} <em class="mp-required">*</em></label>
            ...
            <div class="row">
                <div class="col-md-4 col-4 col-xs-6 mp-pt-10">
                    <label for="" class="mp-pb-5">{l s='Ciudad' mod='mercadopago'} <em class="mp-required">*</em></label>
                ...
                <div class="col-md-4 col-4 col-xs-6 mp-pt-10 m-mp-pr-0">
                    <label for="" class="mp-pb-5">{l s='Estado' mod='mercadopago'} <em class="mp-required">*</em></label>
                ...
                <div class="col-md-4 col-4 col-xs-12 mp-pt-10 mp-m-col">
                    <label for="" class="mp-pb-5">{l s='Código postal' mod='mercadopago'} <em class="mp-required">*</em></label>
            ...
            <div class="row">
                <div class="col-md-12 col-xs-12 col-12 mp-pt-20 mp-m-col">
                    <p class="mp-all-required">{l s='Completa todos los campos, son obligatorios.' mod='mercadopago'}</p>
                </div>
            </div>
            {/if}

            <p class="submp-title-checkout-six">{l s='Por favor, selecciona el emisor de su elección' mod='mercadopago'}</p>
