...
<form id="mp_custom_checkout" class="mp-checkout-form" method="post" action="{$redirect}">
    ...
    <div class="row mp-frame-checkout-custom-seven">
        ...
        <div id="mercadopago-form" class="col-xs-12 col-md-12 col-12">
            <h3 class="mp-title-custom-checkout mp-pt-20">{l s='Ingresa los datos de tu tarjeta' mod='mercadopago'}</h3>
            ...
            <div class="col-md-12 col-12 mp-frame-title">
                <h3 class="mp-title-custom-checkout">{l s='Cuántas cuotas querés pagar' mod='mercadopago'}</h3>
            </div>
            ...
            <div class="form-group">
                ...
                <div id="container-installments" class="col-md-12 col-8 mp-pb-20 mp-pr-0 mp-pl-0 mp-m-col">
                    <label for="id-installments" class="mp-pb-5">{l s='Seleccione el número de cotas'
                        mod='mercadopago'}</label>
            ...
            <div id="mp-doc-div-title" class="col-md-12 col-12 mp-frame-title">
                <h3 class="mp-title-custom-checkout">{l s='Ingresá tu número de documento' mod='mercadopago'}</h3>
            </div>
