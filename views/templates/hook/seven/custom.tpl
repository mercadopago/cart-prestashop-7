        ...
        <div id="mercadopago-form" class="col-xs-12 col-md-12 col-12">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-6 pb-20 pr-0 mp-m-col">
                    ...
                    <input type="text" class="form-control mp-form-control" autocomplete="off" placeholder="{l s='CVV' mod='mercadopago'}" onkeyup="maskInput(this, minteger);" maxlength="4" />
            ...
            <div class="form-group">
                ...
                <div class="col-md-8 col-8 pb-20 pr-0 mp-m-col">
                    ...
                    <input type="text" class="form-control mp-form-control" autocomplete="off" onkeyup="maskInput(this, minteger);"/>
