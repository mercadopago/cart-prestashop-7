        ...
        <div id="mercadopago-form" class="col-xs-12 col-md-12 col-12">
                ...
                <div class="col-md-12 col-12 pb-20 px-0">
                    ...
                    <div class="form-check mp-form-check">
                        <div class="col-md-4 col-4 col-xs-6 m-pr-0">
                            <input class="form-check-input mp-checkbox" type="radio" value="CNPJ" id="defaultRadio2" name="mercadopago_ticket[docType]">
            ...
            <div class="form-group">
                <div class="col-md-4 col-4 col-xs-6 pb-10 pl-0">
                    ...
                    <input type="text" name="mercadopago_ticket[firstname]" class="form-control mp-form-control" autocomplete="off" />
                </div>

                <div class="col-md-4 col-4 comercadopago_ticket[l]-xs-6 pb-10 m-pr-0">
                    <label for="" class="pb-5">{l s='Apellido' mod='mercadopago'} <em class="mp-required">*</em></label>
                    <input type="text" name="mercadopago_ticket[lastname]" class="form-control mp-form-control" autocomplete="off" />
                </div>
                ...
                <div class="col-md-4 col-4 col-xs-12 pb-10 pr-0 mp-m-col">
                    ...
                    <input type="text" name="mercadopago_ticket[docNumber]" class="form-control mp-form-control" autocomplete="off" />
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="col-md-8 col-8 col-xs-8 pb-20 pl-0">
                    ...
                    <input type="text" name="mercadopago_ticket[address]" class="form-control mp-form-control" autocomplete="off" />
                </div>
                ...
                <div class="col-md-4 col-4 col-xs-4 pb-20 pr-0">
                    ...
                    <input type="text" name="mercadopago_ticket[number]" class="form-control mp-form-control" autocomplete="off" />
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="col-md-4 col-4 col-xs-6 pb-20 pl-0">
                    ...
                    <input type="text" name="mercadopago_ticket[city]" class="form-control mp-form-control" autocomplete="off" />
                </div>
                ...
                <div class="col-md-4 col-4 col-xs-6 pb-20 m-pr-0">
                    ...
                    <select name="mercadopago_ticket[state]" class="form-control mp-form-control mp-select pointer">
                ...
                <div class="col-md-4 col-4 col-xs-12 pb-20 pr-0 mp-m-col">
                    ...
                    <input type="text" name="mercadopago_ticket[zipcode]" class="form-control mp-form-control" autocomplete="off" />
                </div>
            </div>
